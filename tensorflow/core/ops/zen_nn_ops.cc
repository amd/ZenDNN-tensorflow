...
REGISTER_OP("_ZenVitisAIQuantize")
    .Input("input: Tinput")
    .Output("output: Toutput")
    .Attr("scale: int=0")
    .Attr("Tinput: type")
...
REGISTER_OP("_ZenVitisAIDequantize")
    .Input("input: Tinput")
    .Output("output: Toutput")
    .Attr("scale: int=0")
    .Attr("Tinput: type")
